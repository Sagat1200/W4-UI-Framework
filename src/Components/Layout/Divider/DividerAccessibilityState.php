...
class DividerAccessibilityState
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'aria_orientation' => $this->ariaOrientation,
    ...
    public function toAttributes(): array
    {
        ...
        if ($this->ariaOrientation !== null) {
            $attributes['aria-orientation'] = $this->ariaOrientation;
        }
