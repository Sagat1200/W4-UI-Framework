...
class GridAccessibilityState
{
    public function __construct(
        public string $role = 'grid',
    ...
    public function toArray(): array
    {
        return [
            ...
            'aria_colcount' => $this->ariaColCount,
    ...
    public function toAttributes(): array
    {
        ...
        if ($this->ariaColCount !== null) {
            $attributes['aria-colcount'] = (string) $this->ariaColCount;
        }
