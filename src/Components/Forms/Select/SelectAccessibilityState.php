...
class SelectAccessibilityState
{
    public function __construct(
        public string $role = 'combobox',
        public string $ariaLive = 'off',
        public bool $ariaAtomic = true,
        public bool $ariaHidden = false,
        public bool $ariaBusy = false,
        public ?bool $ariaExpanded = null,
        public ?bool $ariaMultiSelectable = null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'aria_multiselectable' => $this->ariaMultiSelectable,
    ...
    public function toAttributes(): array
    {
        ...
        if ($this->ariaExpanded !== null) {
            $attributes['aria-expanded'] = $this->ariaExpanded ? 'true' : 'false';
        }

        if ($this->ariaMultiSelectable !== null) {
            $attributes['aria-multiselectable'] = $this->ariaMultiSelectable ? 'true' : 'false';
        }
