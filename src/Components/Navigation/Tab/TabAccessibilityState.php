...
class TabAccessibilityState
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'aria_selected' => $this->ariaSelected,
    ...
    public function toAttributes(): array
    {
        $attributes = [
            ...
            'aria-selected' => $this->ariaSelected ? 'true' : 'false',
        ];
