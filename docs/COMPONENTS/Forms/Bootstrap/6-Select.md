...
```blade
<x-w4-select theme="bootstrap" label="Plan" :options="['basic'=>'Basic','pro'=>'Pro']" :invalid="true" />
<x-w4-select theme="bootstrap" label="Plan" :options="['basic'=>'Basic','pro'=>'Pro']" :loading="true" />
<x-w4-select theme="bootstrap" label="Plan" :options="['basic'=>'Basic','pro'=>'Pro']" :disabled="true" />
```
